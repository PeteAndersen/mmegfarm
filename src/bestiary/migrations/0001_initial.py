# Generated by Django 2.0.6 on 2018-07-15 20:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passive', models.BooleanField(default=False)),
                ('passiveTrigger', models.CharField(blank=True, default='', max_length=30)),
                ('creature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bestiary.Enemy')),
            ],
            options={
                'ordering': ['slot'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permanent', models.NullBooleanField()),
                ('probability', models.FloatField(blank=True, null=True)),
                ('spell', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bestiary.EnemySpell')),
            ],
            options={
                'ordering': ['order'],
            },
